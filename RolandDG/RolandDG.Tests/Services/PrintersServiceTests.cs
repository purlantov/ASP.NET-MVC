...
namespace RolandDG.Tests.Services
{
    ...
    public class PrintersServiceTests
    {
        ...
        {
            // Arrange
            var mockedEfRepository = new Mock<IEfRepository<Printer>>();
            var mockedUnitOfWork = new Mock<IUnitOfWork>();

            //Act and Assert
            Assert.Throws<ArgumentNullException>(() => new PrintersService(null, mockedUnitOfWork.Object));
        }
        ...
        public void Service_ShouldThrowArgumentNullException_WhenUnitOfWorkIsNull()
        {
            ...
            //Act and Assert
            Assert.Throws<ArgumentNullException>(() => new PrintersService(mockedEfRepository.Object, null));
        }
        ...
        public void GetAll_ShouldReturnAllPrintersFromDatabase_WhickAreNotDeleted()
        {
            ...
            var service = new PrintersService(mockedEfRepository.Object, mockedUnitOfWork.Object);
